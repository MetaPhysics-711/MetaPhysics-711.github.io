...
var toggleSidebar = function(){
  jQuery("#sidebar").toggleClass('sidebar-hide');
  jQuery("#toggle-sidebar").toggleClass('sidebar-button-shift');
}
var hideSidebar = function(){
  jQuery("#sidebar").addClass('sidebar-hide');
  jQuery("#toggle-sidebar").addClass('sidebar-button-shift');
}
jQuery("#toggle-sidebar").on("click",toggleSidebar);
jQuery("header").on("click",hideSidebar);
jQuery("#mainContent").on("click",hideSidebar);
jQuery("#footerContent").on("click",hideSidebar);